...
extension Category {
    ...
    static let billsAndUtillities = Category(id: 2, name: "Bills & Utillities", icon: .file_invoice_dollar)
    ...
    static let foodAndDinning = Category(id: 5, name: "Food & Dinning", icon: .hamburger)
    ...
    static let publicTransport = Category(id: 101, name: "Public Transport", icon: .bus, mainCategoryId: 1)
    ...
    static let mobileAndDVDs = Category(id: 301, name: "Mobile & DVDs", icon: .film, mainCategoryId: 3)
